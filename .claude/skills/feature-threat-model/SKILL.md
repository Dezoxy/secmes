...
description: Produce a short threat-model note before building a security-relevant feature in secmes. Use when adding messaging, key, auth, attachment, admin, or tenant features — anything that touches the security boundary — so design risks surface before code.
---
