...
export function ChatInput({ onSend, disabled = false, disabledNotice }: ChatInputProps) {
  ...
  if (disabled) {
    return (
      <div className="pointer-events-none absolute inset-x-0 bottom-[calc(env(safe-area-inset-bottom)_+_0.75rem)] z-20 px-2 pl-[calc(env(safe-area-inset-left)_+_0.5rem)] pr-[calc(env(safe-area-inset-right)_+_0.5rem)]">
