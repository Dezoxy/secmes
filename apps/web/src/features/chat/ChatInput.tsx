...
export function ChatInput({ onSend, disabled = false, disabledNotice }: ChatInputProps) {
  ...
  if (disabled) {
    return (
      <div className="mb-[5.25rem] border-t border-white/5 bg-[#0f0f16]/80 p-4 pb-[calc(env(safe-area-inset-bottom)_+_1rem)] pl-[calc(env(safe-area-inset-left)_+_1rem)] pr-[calc(env(safe-area-inset-right)_+_1rem)] backdrop-blur-xl lg:mb-0">
  ...
  return (
    <div className="mb-[5.25rem] border-t border-white/5 bg-[#0f0f16]/80 p-3 pb-[calc(env(safe-area-inset-bottom)_+_0.75rem)] pl-[calc(env(safe-area-inset-left)_+_0.75rem)] pr-[calc(env(safe-area-inset-right)_+_0.75rem)] backdrop-blur-xl lg:mb-0">
      {/* Attachment previews */}
