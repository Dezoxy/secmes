...
export function ChatHeader({
  ...
  return (
    <div className="relative z-20 flex items-center justify-between bg-[#0f0f16]/75 px-4 pb-3 pt-[env(safe-area-inset-top)] sm:pt-3 pl-[calc(env(safe-area-inset-left)_+_1rem)] pr-[calc(env(safe-area-inset-right)_+_1rem)] backdrop-blur-xl">
