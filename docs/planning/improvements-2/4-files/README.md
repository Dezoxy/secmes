...
| 3 | [Nice to have](./03-nice-to-have.md) | P3 | Items 1-2 implemented and merged; item 3 implemented; deployed verification pending | Better deploy UX, dashboards, and regression checks. |
