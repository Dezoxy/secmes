...
| 2 | [Should improve](./02-should-improve.md) | P2 | Items 1-2 implemented; item 1 merged; deployed verification pending | Observability noise hides real incidents and makes dashboards less trustworthy. |
