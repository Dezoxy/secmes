...
| 2 | [Should improve](./02-should-improve.md) | P2 | Items 1-4 implemented; items 1-3 merged; deployed verification pending | Observability noise hides real incidents and makes dashboards less trustworthy. |
