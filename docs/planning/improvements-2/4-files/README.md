...
|---|-------|----------|--------|----------------|
| 1 | [Must fix](./01-must-fix.md) | P1 | Items 1-4 implemented; items 1-3 merged; deployed verification pending | User-visible stale Friends state plus false critical alerts. |
