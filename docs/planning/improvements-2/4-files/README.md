...
|---|-------|----------|--------|----------------|
| 1 | [Must fix](./01-must-fix.md) | P1 | Items 1-3 implemented; items 1-2 merged; deployed verification pending | User-visible stale Friends state plus false critical alerts. |
